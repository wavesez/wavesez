 ...
 /*
 Theme Owned and Made by wave.s
...
#app-mount .container-1NXEtd, .privateChannels-oVe7HL, .app-1BipOi .standardSidebarView-E9Pc3j, .app-1BipOi .container-2cd8Mz {
    background: transparent;
...
.app-1BipOi .chat-2ZfjoI, .app-1BipOi .scrollableContainer-15eg7h {
    background: transparent;
...
.themeDark-3Ap_7i, .app-1BipOi .chat-9g_3Xj {
    background-color: transparent;
    background-image: var(--transparency-3);
}
.typeWindows-3ILlhq {
...
/*Home and Discover*/
    ...
    /*Now Active*/
        ...
        #app-mount .nowPlayingColumn-1eCBCN .itemCard-3Etziu:hover {background-color: var(--secondary1-colour);}
        #app-mount .nowPlayingColumn-1eCBCN .itemCard-3Etziu .body-16rSsp {background-color: var(--secondary2-colour);}
...
/*In Servers*/
    ...
    /*Channels*/
        ...
        /*Voice Channels*/
            ...
            /*VC Info*/
                #app-mount .container-1CH86i,
                #app-mount .container-2NLBJg {
                    background-color: transparent;
                }
            ...
            /*VC User*/
                ...
                #app-mount .userAvatar-3Hwf1F { margin-left: 15px; }


                #app-mount .avatarSpeaking-2pCGrZ {box-shadow: 0 0 0 2px var(--primary1-colour);}
                #app-mount .avatarSpeaking-2pCGrZ::after {
                    content: ":";
                    color: transparent; 
...
/*Server Members*/
    ...
    #app-mount .membersGroup-2YoqY- span {color: var(--activetext-colour);}
    #app-mount .membersGroup-2YoqY- {
        background-color: var(--primary3-colour);
...
/*Emoji, Gif and SoundBoard Picker Popup*/
    ...
    #app-mount .contentWrapper-2f9yME,
    #app-mount .picker-20lcBA {
        background-color: var(--secondary3-colour); 
    }
    #app-mount .contentWrapper-3vHNP2 .inspector-DFKXwB,
    #app-mount .contentWrapper-2f9yME .inspector-DFKXwB,
    ...
    #app-mount .contentWrapper-3vHNP2 .result-pzZrwj[style*="background-color: rgb(146, 154, 250);"] {background-color: var(--primary2-colour)!important}

/*TopBar*/
    #app-mount .typeWindows-3ILlhq {
        background-color: var(--secondary3-colour); 
        border-bottom: 2px solid var(--primary3-colour); 
        height: 30px;
        margin: 0px;
    }
    #app-mount .typeWindows-3ILlhq:after {
        content: " ";
    ...
    #app-mount .wordmark-3wYFg6 {top: 3.3px;}
    #app-mount .winButton-3SigSb {top: 2px;}
